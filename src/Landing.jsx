  ...
  return (
    <div className="bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-slate-950 to-black text-white min-h-screen relative overflow-hidden font-sans flex flex-col justify-center items-center cursor-none">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 animate-fade-in-up">
        ...
        <p className="text-2xl md:text-4xl text-gray-300 font-light max-w-4xl leading-relaxed mb-14">
          Building AI-powered solutions for real-world impact 🤖
        </p>

        <Link 
          to="/home"
          className="bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-400 hover:to-purple-500 text-white font-black py-6 px-16 rounded-full shadow-[0_0_30px_rgba(168,85,247,0.5)] hover:shadow-[0_0_50px_rgba(6,182,212,0.8)] transform hover:-translate-y-2 hover:scale-110 transition-all duration-300 flex items-center gap-5 group text-2xl uppercase tracking-widest cursor-none"
        >
          <span>Explore My Work</span>
          <span className="group-hover:translate-x-2 group-hover:-translate-y-2 group-hover:scale-110 transition-transform duration-300 text-3xl">🚀</span>
        </Link>
